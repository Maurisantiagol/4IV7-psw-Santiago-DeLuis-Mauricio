 ...
 * @author PCMASTERACE
 */
public class Editarfinal extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter()) {
            ...
            int id,Eedad;
            String Enom,Eappat,Eapmat,Ecorreo;
            
            id = Integer.parseInt(request.getParameter("ideditar"));
            Enom = request.getParameter("nombree");
            Eappat = request.getParameter("appate");
            Eapmat = request.getParameter("appmate");
            Ecorreo = request.getParameter("emaile");
            Eedad = Integer.parseInt(request.getParameter("edade"));
            ...
            */
            String q;
                    ...
                    q="UPDATE mregistro SET nom_usu = '"+Enom+"', appat_usu = '"+Eappat+"',"
                            + " apmat_usu = '"+Eapmat+"', edad_usu = '"+Eedad+"', email_usu = '"+Ecorreo+"' where id_usu ="+id; 
                     try{
                            set.executeUpdate(q);
           ...
           out.println("<a href='index.html'>Regresar al Formulario</a>"
                    ...
                    + "<br>"
                    + "<a href='Consultar2'>Consultar la Tabla General de Usuarios</a></div>"
                   + "<footer><div><h1>Información de contacto</h1></div><p><span class=\"material-icons-outlined\" >phone</span>Telefono: 5583648857</p><p><span class=\"material-icons-outlined\">facebook</span><a href=\"https://www.facebook.com/profile.php?id=100009774423321\">Mauricio Santiagol</a></p><p><span class=\"material-icons-outlined\">email</span>Email:<a href=\"mailto:Santiagodeluismauricio@gmail.com\">Santiagodeluismauricio@gmail.com</a></p></footer>");
            out.println("</body>");
            out.println("</html>");
        }
    }
